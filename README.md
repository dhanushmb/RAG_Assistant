...
**A local, private Retrieval-Augmented Generation (RAG) chatbot with conversation awareness.**

I built this project from the ground up to run powerful local LLMs with document-aware conversations, all running privately on your own machine. It combines a custom memory system, vector search, and streaming responses using llama.cpp.

[![pre-commit](https://img.shields.io/badge/pre--commit-enabled-brightgreen?logo=pre-commit)](https://github.com/pre-commit/pre-commit)
[![Code style: Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/astral-sh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)

Check out the todo list to see the next steps and improvements [here](notes/todo.md).
...
> [!NOTE]
> To decide which hardware to use/buy to host local LLMs, it is recommended to read these great benchmarks:
...
> [!NOTE]
> The `RecursiveCharacterTextSplitter` (for Markdown-aware chunking) was refactored from LangChain's implementation
> to avoid adding LangChain as a dependency. Full credit to LangChain for the original approach (see license notice in the source file).
...
To deal with context overflows, the project implements two approaches:
...
defined in the `version/poetry` file in this repository.
...
To easily install the dependencies and start the services, this project includes a Makefile.
...
![rag-example](images/rag-example.gif)
...
![rag-load-doc-example](images/rag-load-doc-example.gif)
